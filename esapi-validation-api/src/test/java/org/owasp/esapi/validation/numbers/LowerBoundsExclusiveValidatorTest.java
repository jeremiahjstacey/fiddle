...
public class LowerBoundsExclusiveValidatorTest {
	...
	public LowerBoundsExclusiveValidatorTest(Number minValue, Number tooLow, Number goodNumber) {
		minConfiguration = minValue;
		invalidNumber = tooLow;
		validNumber = goodNumber;
		testInstance = new LowerBoundsValidator<>(minConfiguration, false);
	}
	...
	@Test
	public void testExclusiveBoundaryTooLow() {
